from utils import load_csv, get_cost, plot_solution, plot_progress, print_output, compare_solutions
import time
...
if __name__ == "__main__":
	...
	print_output("Greedy Drop Neighbourhood Search", end, n_cost, len(cities), num_stations)
	
	solutions = [solution, n_sol]
	names = [f"Greedy Drop - {best_cost}", f"Greedy Drop Neighbourhood Search - {n_cost}"]
